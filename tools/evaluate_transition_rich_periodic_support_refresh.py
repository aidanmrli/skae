...
2. Compare no-refresh source-latent continuation, current-state global
   continuation, periodic global decode/re-encode, frozen-source gated K, and
   refreshed-current gated K.
...
def _write_summary(path: Path, rows: Sequence[Dict[str, object]]) -> None:
    ...
    lines = [
        ...
        "",
        "This directly tests whether post-entry re-encoding refreshes support and whether the refreshed support routes later Koopman evolution differently from a frozen source support.",
        "",
        "## Coverage",
        "",
        ...
        "## Aggregate Metrics",
        "",
        "| root | support_definition | object | start | mode | period | rows | init_target | post_target | refresh | mse | refreshed/frozen | reencode/no_reencode | route_target | fallback | chatter |",
        "| --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
    ]
