#!/usr/bin/env python3
"""Frozen ``F_abs`` support-family routing used by the staged paper model.
...
trainer: the paper protocol is implemented by
``tools/train_staged_support_family_local_k.py``.
"""
