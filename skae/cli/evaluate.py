"""
Standard command-line evaluation for trained SKAE checkpoints.
...
Usage:
    uv run skae-evaluate --run_dir runs/kae/<timestamp> --system duffing
    uv run skae-evaluate --run_dir runs/kae/<timestamp> --system pendulum --device cpu
    uv run skae-evaluate --run_dir runs/kae/<timestamp> --system lorenz63 --checkpoints checkpoint.pt
"""
...
def evaluate_checkpoint(
    ...
    load_model_state_dict_compat(eval_model, checkpoint['model_state_dict'])
