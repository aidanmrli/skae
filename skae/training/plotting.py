"""
Training-metric plotting implementation.

Usage:
    uv run skae-plot-training runs/quick_test/20251106-223912
    uv run skae-plot-training runs/quick_test/20251106-223912 --metrics loss residual_loss
"""
