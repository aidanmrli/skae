#!/bin/bash
#
# Duffing unstructured LISTA parity full run: L=1 vs L=8.
# Grid: 2 sequence lengths x 3 seeds = 6 runs.
#
# Submit:
#   sbatch scripts/sweep_duffing_lista_pairseq_full.sh
#
# Optional overrides:
...
#SBATCH -o /network/scratch/l/lia/skae/duf-lista-fl-%A_%a.out
#SBATCH --requeue
#SBATCH --array=0-5
...
echo "============================================="
echo "Duffing LISTA PairSeq Full"
