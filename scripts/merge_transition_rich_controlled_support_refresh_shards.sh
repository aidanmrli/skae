#!/bin/bash
#
# Merge controlled support-refresh shard outputs into standard artifacts.
#
# Required env vars:
...
#
# Optional env vars:
#   ROWS_CSVS=<comma-separated forecasting_rows.csv files used to build shards>
...
#
#SBATCH --job-name=tr_sup_refresh_merge
#SBATCH --ntasks=1
#SBATCH --partition=long
#SBATCH --cpus-per-task=1
#SBATCH --mem=4G
#SBATCH --time=00:30:00
#SBATCH -o /network/scratch/l/lia/skae/tr-sup-refresh-merge-%A.out
#SBATCH -e /network/scratch/l/lia/skae/tr-sup-refresh-merge-%A.err
...
echo "============================================="
echo "Merge Transition-Rich Controlled Support Refresh Shards"
...
uv run python tools/merge_transition_rich_controlled_support_refresh_shards.py \
