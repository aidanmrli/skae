#!/bin/bash
# Queue the frozen 15-system x six-row x 15-seed controlled matrix.
#
# Submit with:
...
if [[ -z "${SLURM_JOB_ID:-}" ]]; then
  echo "Submit this launcher with sbatch scripts/neurips_2026/controlled/queue_training.sh"
  exit 2
fi
