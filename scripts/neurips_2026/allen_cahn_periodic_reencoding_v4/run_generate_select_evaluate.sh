#!/usr/bin/env bash
#SBATCH --job-name=ac-periodic-v4-gpu
#SBATCH --output=/network/scratch/l/lia/skae/ac-periodic-v4-gpu-%j.out
#SBATCH --error=/network/scratch/l/lia/skae/ac-periodic-v4-gpu-%j.err
...
RAW_TELEMETRY="$(mktemp /network/scratch/l/lia/skae/ac-periodic-v4-gpu-${SLURM_JOB_ID}-XXXXXX.csv)"
nvidia-smi \
