#!/bin/bash
#
# Queue the frozen Dysts training matrix and long-horizon reevaluation.
#
# Submit:
...
# Optional env vars:
#   DATE_TAG=20260430
#   BASE_OUT=<shared scratch>/skae/dysts_dt30_basinblock_p256_seq10_100k_${DATE_TAG}
...
BASE_OUT="${BASE_OUT:-${SKAE_SCRATCH_ROOT}/dysts_dt30_basinblock_p256_seq10_100k_${DATE_TAG}}"
