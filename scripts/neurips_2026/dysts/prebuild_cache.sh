#!/bin/bash
#
# Prebuild Dysts caches over system, profile, and split.
#
# Submit:
#   sbatch scripts/neurips_2026/dysts/prebuild_cache.sh
#
# Required at submission:
#   SYSTEMS_FILE=<generated paper-system list>
#   sbatch --array=0-$((systems * profiles * splits - 1)) ...
# Optional overrides:
#   CACHE_DIR=<shared scratch>/skae/dysts_native_cache
#   CACHE_NUM_WORKERS=2
#   PROFILES="full"
