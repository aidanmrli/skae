#!/usr/bin/env bash
#SBATCH --job-name=ac-periodic-v2-summary
#SBATCH --output=/network/scratch/l/lia/skae/ac-periodic-v2-summary-%j.out
#SBATCH --error=/network/scratch/l/lia/skae/ac-periodic-v2-summary-%j.err
