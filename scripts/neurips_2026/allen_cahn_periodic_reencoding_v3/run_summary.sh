#!/usr/bin/env bash
#SBATCH --job-name=ac-periodic-v3-summary
#SBATCH --output=/network/scratch/l/lia/skae/ac-periodic-v3-summary-%j.out
#SBATCH --error=/network/scratch/l/lia/skae/ac-periodic-v3-summary-%j.err
