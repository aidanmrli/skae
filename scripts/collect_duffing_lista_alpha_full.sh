#!/bin/bash
#
# Collect Duffing LISTA Queue-1 full alpha sweep summary.
#
# Submit:
#   sbatch scripts/collect_duffing_lista_alpha_full.sh
#
# Optional overrides:
...
#   SUMMARY_PREFIX=duffing_lista_alpha_full_50k
#
#SBATCH --job-name=collect_ls1f
#SBATCH --ntasks=1
#SBATCH --partition=long
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH -o /network/scratch/l/lia/skae/collect-ls1f-%j.out
...
echo "============================================="
echo "Collect Duffing LISTA Queue-1 Full"
