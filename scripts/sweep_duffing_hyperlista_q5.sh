...
echo "HyperLISTA use_ss: ${HYPER_USE_SS}"
echo "HyperLISTA use_momentum: ${HYPER_USE_MOMENTUM}"
echo "HyperLISTA constrain_c_theta: ${HYPER_CONSTRAIN_C_THETA}"
echo "HyperLISTA c_theta_min: ${HYPER_C_THETA_MIN}"
echo "Arm: ${ARM}"
echo "Seed: ${SEED}"
...
TRAIN_ARGS=(
  ...
  --hyperlista_use_ss "${HYPER_USE_SS}"
  --hyperlista_use_momentum "${HYPER_USE_MOMENTUM}"
  --hyperlista_constrain_c_theta "${HYPER_CONSTRAIN_C_THETA}"
  --hyperlista_c_theta_min "${HYPER_C_THETA_MIN}"
)
