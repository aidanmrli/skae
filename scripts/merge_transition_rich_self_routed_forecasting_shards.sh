#!/bin/bash
#
# Merge per-root self-routed-forecasting shard outputs into the standard artifacts.
#
# Required env vars:
#   SHARDS_DIR=<directory containing per-root shard outputs>
#   OUT_DIR=<merged self-routed-forecasting output directory>
#
# Optional env vars:
...
#SBATCH -o /network/scratch/l/lia/skae/tr-self-route-merge-%A.out
#SBATCH -e /network/scratch/l/lia/skae/tr-self-route-merge-%A.err
...
echo "============================================="
echo "Merge Transition-Rich Self-Routed Forecasting Shards"
...
uv run python tools/merge_transition_rich_self_routed_forecasting_shards.py \
