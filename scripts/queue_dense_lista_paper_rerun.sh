...
EXPERIMENT_TAG="${EXPERIMENT_TAG:-dense_lista_paper_rerun_${DATE_TAG}}"
PHASE_LABEL="${PHASE_LABEL:-paper_rerun}"
...
RECIPE_SPECS_CSV="${RECIPE_SPECS_CSV:-lista_dense_ns200k_lr5em5_klr5em6_wd1em4_rc3em2_pc1ep0_sc3em3:200000:5e-5:5e-6:1e-4:0.03:1.0:0.003}"

mkdir -p "${TASK_DIR}" "${ROOT_SPEC_DIR}" "${COLLECT_DIR}" "${COMPARE_DIR}"

TASK_TSV="${TASK_DIR}/dense_lista_paper_rerun.tsv"
MANIFEST_JSON="${TASK_DIR}/dense_lista_paper_rerun_manifest.json"
ROOT_SPECS_FILE="${ROOT_SPEC_DIR}/dense_lista_paper_rerun_roots.txt"
...
echo "Queued dense LISTA paper rerun."
