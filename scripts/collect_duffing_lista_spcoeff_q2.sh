#!/bin/bash
#
# Collect Duffing LISTA Queue-2 sparsity-coefficient sweep summary.
#
# Submit:
#   sbatch scripts/collect_duffing_lista_spcoeff_q2.sh
#
# Optional overrides:
...
#
#SBATCH --job-name=collect_ls2
#SBATCH --ntasks=1
#SBATCH --partition=long
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH -o /network/scratch/l/lia/skae/collect-ls2-%j.out
...
echo "============================================="
echo "Collect Duffing LISTA Queue-2 Sparsity Sweep"
