...
echo "STAGED_SUPPORT_DEFINITION: ${STAGED_SUPPORT_DEFINITION}"
echo "STAGED_FAMILY_JACCARD_THRESHOLD: ${STAGED_FAMILY_JACCARD_THRESHOLD}"
...
VALIDATE_JOB_ID=$(
  ...
  STAGED_SUPPORT_DEFINITION="${STAGED_SUPPORT_DEFINITION}" \
  STAGED_FAMILY_JACCARD_THRESHOLD="${STAGED_FAMILY_JACCARD_THRESHOLD}" \
