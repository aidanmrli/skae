#!/bin/bash
#
#SBATCH --job-name=dysts_fcast_p1
#SBATCH --ntasks=1
...
#SBATCH -o /network/scratch/l/lia/skae/dysts-fcast-p1-%A_%a.out
#SBATCH --requeue
#SBATCH --array=0-44
...
BASE_OUT="${BASE_OUT:-/network/scratch/l/lia/skae/dysts_forecast_phase1_lista_relu_sp15_ts256}"
mkdir -p "$BASE_OUT"
...
echo "============================================="
echo "Dysts Forecast Phase 1 (LISTA ReLU + sp1.5)"
