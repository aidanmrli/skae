#!/bin/bash
#
# Merge per-root periodic support-refresh shard outputs into standard artifacts.
#
# Required env vars:
...
#
#SBATCH --job-name=tr_refresh_merge
#SBATCH --ntasks=1
#SBATCH --partition=long
#SBATCH --cpus-per-task=1
#SBATCH --mem=4G
#SBATCH --time=00:30:00
#SBATCH -o /network/scratch/l/lia/skae/tr-refresh-merge-%A.out
#SBATCH -e /network/scratch/l/lia/skae/tr-refresh-merge-%A.err
...
echo "============================================="
echo "Merge Transition-Rich Periodic Support Refresh Shards"
...
uv run python tools/merge_transition_rich_periodic_support_refresh_shards.py \
