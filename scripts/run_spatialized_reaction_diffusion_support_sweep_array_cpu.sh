#!/usr/bin/env bash
#SBATCH --job-name=spatial-rd-support-sweep-cpu
#SBATCH --output=/network/scratch/l/lia/skae/spatial-rd-support-sweep-cpu-%A_%a.out
#SBATCH --error=/network/scratch/l/lia/skae/spatial-rd-support-sweep-cpu-%A_%a.err
