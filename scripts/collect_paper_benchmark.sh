#!/bin/bash
#
# Collect forecasting artifacts for the research-paper benchmark.
#
# Required env vars:
...
#   PAPER_SUMMARY=1
#
#SBATCH --job-name=collect_paper
#SBATCH --ntasks=1
#SBATCH --partition=long
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --time=02:00:00
#SBATCH -o /network/scratch/l/lia/skae/collect-paper-%A.out
#SBATCH -e /network/scratch/l/lia/skae/collect-paper-%A.err
...
if [[ "${PAPER_SUMMARY}" == "1" ]]; then
  uv run python tools/summarize_paper_benchmark_results.py \
