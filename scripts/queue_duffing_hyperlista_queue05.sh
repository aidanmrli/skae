...
HYPER_USE_SS="${HYPER_USE_SS:-true}"
HYPER_USE_MOMENTUM="${HYPER_USE_MOMENTUM:-true}"
HYPER_CONSTRAIN_C_THETA="${HYPER_CONSTRAIN_C_THETA:-true}"
HYPER_C_THETA_MIN="${HYPER_C_THETA_MIN:-1e-6}"
...
echo "HYPER_USE_SS: ${HYPER_USE_SS}"
echo "HYPER_USE_MOMENTUM: ${HYPER_USE_MOMENTUM}"
echo "HYPER_CONSTRAIN_C_THETA: ${HYPER_CONSTRAIN_C_THETA}"
echo "HYPER_C_THETA_MIN: ${HYPER_C_THETA_MIN}"
...
SWEEP_JOB_ID=$(SPARSITY_COEFFS="${SPARSITY_COEFFS}" LISTA_NUM_LOOPS_CSV="${LISTA_NUM_LOOPS_CSV}" HYPER_C_THETAS="${HYPER_C_THETAS}" SEEDS_CSV="${SEEDS_CSV}" sbatch \
  --array="${ARRAY_SPEC}" \
  --export=ALL,BASE_OUT="${BASE_OUT}",NUM_STEPS="${NUM_STEPS}",BATCH_SIZE="${BATCH_SIZE}",TARGET_SIZE="${TARGET_SIZE}",SEQUENCE_LENGTH="${SEQUENCE_LENGTH}",EVAL_PROFILE="${EVAL_PROFILE}",HYPER_C_BETA="${HYPER_C_BETA}",HYPER_C_SS="${HYPER_C_SS}",HYPER_USE_SS="${HYPER_USE_SS}",HYPER_USE_MOMENTUM="${HYPER_USE_MOMENTUM}",HYPER_CONSTRAIN_C_THETA="${HYPER_CONSTRAIN_C_THETA}",HYPER_C_THETA_MIN="${HYPER_C_THETA_MIN}" \
