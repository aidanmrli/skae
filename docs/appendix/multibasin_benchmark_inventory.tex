...
\cref{tab:forecasting_main}, \cref{tab:fixed17_alignment}, and
\cref{fig:fixed17_horizon_curves}. The support-refresh
...
continuous-time vector fields and attractor annotations are shown here only to
document the benchmark geometry and are not provided to the learner.}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_arrested_spiral.pdf}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_cal_asymmetric_3.pdf}
  \caption{Asymmetric three-well.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_cal_high_cross_3.pdf}
  \caption{High-cross three-well.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_cal_hexagon_6.pdf}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_cal_octagon_8.pdf}
  \caption{Octagonal eight-well.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_cal_pentagon_5.pdf}
  \caption{Pentagonal five-well.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_cal_square_4.pdf}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_duffing_triple_well.pdf}
  \caption{Triple-well Duffing.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_snic_multi.pdf}
  \caption{SNIC multi-attractor.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_transition_routes_4.pdf}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_var_depth_gradient_4.pdf}
  \caption{Depth-gradient four-well.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_var_diamond_4.pdf}
  \caption{Diamond four-well.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\linewidth]{neurips_paper_2026/ground_truth_vector_fields/ground_truth_vector_field_claude_var_l_shape_5.pdf}
