...
from experiments.neurips_2026.alignment import _load_checkpoint_model
...
def main() -> None:
    ...
    _configure_paper_style()
    env, model = _load_checkpoint_model(checkpoint_path, system_key, args.device)
