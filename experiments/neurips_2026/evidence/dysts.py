...
METHODS = OrderedDict(
    [
        ...
        ("lista_bd", (DYSTS_MODEL_DISPLAY_NAMES["lista_bd"], "#0072B2", "-")),
        ("lista_sb", (DYSTS_MODEL_DISPLAY_NAMES["lista_sb"], "#56B4E9", "-")),
        ("sparse_mlp", (DYSTS_MODEL_DISPLAY_NAMES["sparse_mlp"], "#009E73", "--")),
        (
            "sparse_mlp_bd",
            (DYSTS_MODEL_DISPLAY_NAMES["sparse_mlp_bd"], "#44AA99", "--"),
        ),
        (
            "dense_mlp_tanh",
            (DYSTS_MODEL_DISPLAY_NAMES["dense_mlp_tanh"], "#D55E00", "--"),
        ),
    ]
)
OUTPUT_PATHS = (
