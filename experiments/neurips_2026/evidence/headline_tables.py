"""Build the paper's compact headline forecasting and support tables.
...
from experiments.neurips_2026.evidence.statistics import interquartile_mean as iqm
from experiments.neurips_2026.evidence.table_rendering import write_tables
