"""Freeze compact, authenticated rows for the paper's main tables."""
...
from experiments.neurips_2026.evidence.statistics import IQM_CONVENTION
from experiments.neurips_2026.paths import PAPER_DATA_DIR, results_root

DEFAULT_OUTPUT_DIR = PAPER_DATA_DIR
